                ...
                <td align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href = "<?=__SITE_URL?>adminhome/deleteCat/id:<?=$this->registry->security->encryptData($catArray['expert_category_id'])?>" onClick="return confirm('Do You really Want To Delete This?');">
