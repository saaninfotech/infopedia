        ...
        ?>
            <form name="mass_payment" id="mass_payment" action="" method="POST">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="center"
                            ...
                            Total Payable Amount: $<span id="show_amount" style="color:#FF0000;">0.00</span> <input
                                type="hidden" value="0" name="total_amount_value" id="total_amount_value">| Total Selected
                            ...
                            <br>
                            <input class="sensitive" type="submit" name="payment_button" id="payment_button_top" value="Continue Payment">
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                                    ...
                                    foreach ($ExpertPayableListArray as $expertPayableArray) {
                                        if (($counter % 6) == 0) {
                                            ...
                                            <td align='center'>
                                                ...
                                                <br>
                                                <strong>Due Amount:$<?=$expertPayableArray['amount_due_value']?></strong>
                                            </td>
                                            <?php
                                        }
                                        $counter++;
                    ...
                    <tr>
                        <td align="center">
                            <input class="sensitive" type="submit" name="payment_button" id="payment_button_bottom" value="Continue Payment">
                        </td>
                    </tr>
                </table>
            </form>
