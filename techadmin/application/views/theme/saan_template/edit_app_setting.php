    ...
    <div id="content" class="box">
        ...
        <form name="form1" method="post" action="">
            <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="margin-left:60px;">
                <tr>
                    <td><h2>Change the Setting Value for the <?=ucwords(str_replace("_", " ", $SettingArray['app_setting_name']))?></h2></td>
                </tr>
                <tr>
                    <td>Setting Content:</td>
                </tr>
                <tr>
                    <td><textarea id="app_setting_value" name="app_setting_value"><?=stripslashes($SettingArray['app_setting_value'])?></textarea></td>
                </tr>
                <tr>
