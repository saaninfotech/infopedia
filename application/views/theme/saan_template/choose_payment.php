                                ...
                                <!-- Sign Up Form -->
                                	...
                                	<table width="90%" cellpadding="0" cellspacing="0" style="margin-left:40px; margin-top:30px; margin-bottom:30px;">
                                    	...
                                    	<tr>
                                            ...
                                            <td><a href="<?=__SITE_URL?>advice/expressCheckout/request_id:<?=$RequestId?>"><img src="<?=__TEMPLATE_URL?>images/paypal_pay.jpg"></a></td>
                                        </tr>
                                        <tr>
                                        	<td colspan="2">
                                            	<div id="credit_card_section">
                               					  <form name="adviceform" id="adviceform" action="<?=__SITE_URL?>advice/directPayment" method="post">
                                          ...
                                          <tr>
                                                   	...
                                                   	<td><input name="first_name" type="text" id="first_name" size="26" ></td>
                                                          ...
                                                          <tr>
                                                            <td align="left" valign="top">Credit Card Type</td>
                                                   	  <td>
                                                          ...
                                                          <tr>
                                                            <td align="left" valign="top">Credit Card Number</td>
                                                          	<td><input name="credit_card_num" type="text" id="credit_card_num" size="26"></td>
                                                          </tr>
                                                          <tr>
                                                            <td align="left" valign="top">Expiry Date</td>
                                                   	  <td>
                                                          ...
                                                          <tr>
                                                            <td colspan="2" align="left" valign="top"><strong>Billing Address Information: </strong></td>
                                                          </tr>
                                                          <tr>
                                                          ...
                                                          <tr>
                                                            <td align="left" valign="top">City:</td>
                                                          	<td><input name="city" type="text" id="city" size="26"></td>
                                                          </tr>
                                                          <tr>
                                                            <td align="left" valign="top">State:</td>
                                                          	<td><input name="state" type="text" id="state" size="26"></td>
                                                          </tr>
                                                          <tr>
                                                            <td align="left" valign="top">Zip:</td>
                                                          	<td><input name="zip" type="text" id="zip" size="26"></td>
                                                          </tr>
                                                          <tr>
                                                          	<td>&nbsp;</td>
                                                            <td>
                                                            	<input type="hidden" name="customer_number" id="customer_number" value="<?=$RequestId?>">
                                                                <input type="submit" name="pay_now" id="pay_now" value="Finalize Payment"></td>
                                                      </tr>
                                                        </table>       
                                                  </form>                
                                                </div>
