                    ...
                    <div class="wContentBox">
                        <div class="greyBox3">
                            <div class="greyBoxInner3 page">
                                ...
                                <h2>Express Checkout Payment Status</h2>
                                    ...
                                    <tr>
                                        <td>
                                            <div id="credit_card_section"
                                                ...
                                                {
                                                    if ($_SESSION['last_payment_id'] == "cancel")
                                                    {
                                                    ?>
                                                        <table width="100%" border="0" cellspacing="5" cellpadding="5">
                                                            <tr>
                                                                ...
                                                                <td width="92%" align="left" valign="top"><span
                                                                        style="font-size:16px; font-weight:bold; margin-left:-4px;">The transaction was cancelled bu you.</span></td>
                                                          </tr>
                                                        </table>
                                                    <?php
                                                    }
